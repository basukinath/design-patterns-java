...
public final class Example {
  ...
  record AuthorizedDocuments(Documents target, Supplier<Identity> identity) implements Documents {
    AuthorizedDocuments {
    ...
    public String read(DocumentRef reference) {
      ...
      if (caller == null
          || !caller.permissions().contains(Permission.READ_REPORT)
  ...
  public static void main(String[] args) throws Exception {
    ...
    expect(
        ...
        () -> new AuthorizedDocuments(tracked, () -> new Identity("tenant-a", Set.of())).read(ref));
    expect(
        SecurityException.class,
        () ->
            new AuthorizedDocuments(tracked, () -> reader)
                .read(new DocumentRef("tenant-b", "report-1")));
    check(calls[0] == 0);
    expect(
        NoSuchElementException.class,
        () ->
            new AuthorizedDocuments(store, () -> reader)
                .read(new DocumentRef("tenant-a", "missing")));
