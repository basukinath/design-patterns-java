...
record Column(String key, String heading) {
    Column {
        ...
        if (key.isBlank() || heading.isBlank())
...
static final class ReportDraft {
    ...
    ReportDraft(UUID id, String title, List<Column> columns,
    ...
    void addColumn(Column column) { columns.add(Objects.requireNonNull(column)); }
    ...
    List<Column> columns() { return List.copyOf(columns); }
    Map<String, String> filters() { return Map.copyOf(filters); }
}
