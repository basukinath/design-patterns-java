...
public final class ReportExports {
    ...
    public interface PdfRenderer {
        ...
        void render(Report report, PdfOptions options, OutputStream target)
                throws IOException;
    }
    ...
    public interface ExcelRenderer {
        ...
        void render(Report report, ExcelOptions options, OutputStream target)
                throws IOException;
    }
    ...
    public static final class PdfReportExporter implements ReportExporter {
        ...
        public void export(Report report, OutputStream target) throws IOException {
            renderer.render(Objects.requireNonNull(report, "report"), options,
    ...
    public static final class CsvReportExporter implements ReportExporter {
        ...
        private static void writeRow(List<String> cells, OutputStream target)
                throws IOException {
    ...
    public static final class ReportExporterFactory {
        ...
        public ReportExporterFactory(
                PdfRenderer pdfRenderer, ExcelRenderer excelRenderer,
                PdfOptions pdfOptions, ExcelOptions excelOptions) {
    ...
    public static final class ReportExportService {
        ...
        public void export(Report report, ExportFormat format, OutputStream target)
                throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        var report = new Report(List.of("Order", "Total"),
