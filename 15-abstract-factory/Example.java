...
public final class Example {
  ...
  static final class MemoryStorageFactory implements StorageFactory {
    ...
    public DownloadLinks createLinks() {
      return object -> {
        if (object.backend() != backend) throw new IllegalArgumentException("Wrong storage family");
        ...
        return java.net.URI.create(
            "demo://" + backend.name().toLowerCase(Locale.ROOT) + "/" + object.id());
      };
    }
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    expect(
        ...
        () ->
            primary.createLinks().forObject(new StoredObject(Backend.PRIMARY, UUID.randomUUID())));
