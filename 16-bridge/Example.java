...
public final class Example {
  record Message(String subject, String body) {
    Message {
      ...
      if (subject.isBlank() || body.isBlank()) throw new IllegalArgumentException("Empty message");
    }
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    DeliveryChannel failing =
        (to, message) -> {
          throw new IllegalStateException("Unavailable");
        };
    expect(
        IllegalStateException.class, () -> new ReceiptNotice(orderId, failing).sendTo(recipient));
